...
def mapc2p(xc, yc):
    ...
    if map_type=='nomap':
        ...
        xp=2.5*xp
        yp=2.5*yp
    elif map_type=='pillowdisk':
        xp,yp,_=mapc2p_pillowdisk(xc,yc)
        xp=2.5*xp
        yp=2.5*yp
    elif map_type=='pillowdisk5':
        alpha=0.4
        xp,yp,_=mapc2p_pillowdisk5(xc,yc,alpha)
        xp=2.5*xp
        yp=2.5*yp
    else:
...
#--------------------------
    ...
    plotitem.pcolor_cmap = plt.cm.jet
